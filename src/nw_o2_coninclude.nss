        ...
        void CreateGenericMiscItem(object oTarget, object oAdventurer, int nModifier=0)
        {
            ...
            else if (GetRange(4, nHD))   // * 800 - 10000
            {
                ...
                switch (nRandom)
                {
                 ...
                 case 26: sItem = "nw_it_mneck026"; break;
            ...
            else if (GetRange(5, nHD))   // * 2500 - 16500
            {
                ...
                switch (nRandom)
                {
                 ...
                 case 7: sItem = "nw_it_mneck026"; break;
        ...
        void CreateSpecificMonkWeapon(object oTarget, object oAdventurer, int nModifier = 0)
        {
            ...
            else  // * 16000 +
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 5: sItem = "nw_wspmka003"; break;
                       ...
                       case 12: sItem = "nw_waxmhn005"; break;
        ...
        void CreateSpecificDruidWeapon(object oTarget, object oAdventurer, int nModifier = 0)
        {
            ...
            else  // * 16000 +
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 6: sItem = "nw_wbwmsl007"; break;
                       case 7: sItem = "nw_wswmdg003"; break;
        ...
        void CreateSpecificMiscItem(object oTarget,object oAdventurer)
        {
            ...
            else if (GetRange(4, nHD))   // * 2500 - 16500
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 16: sItem = "nw_it_mring005"; break;
            ...
            else if (GetRange(5, nHD))   // * 8000 - 25000
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 7: sItem = "nw_it_mring005"; break;
           ...
           string sItem = "";
            ...
            else if (GetRange(5, nHD))   // * 8000 - 25000
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 17: sItem = "nw_wbwmxl004"; break;
                       ...
                       case 27: sItem = "nw_wplmss006"; break;
                   }
            ...
            else if (GetRange(6, nHD))   // * 16000 and up
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 6: sItem = "nw_wbwmxl004"; break;
                       ...
                       case 16: sItem = "nw_wplmss006"; break;
        ...
        void CreateSpecificMartial(object oTarget, object oAdventurer)
        {
            ...
            else if (GetRange(3, nHD))   // * 800 - 10000
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 14: sItem = "nw_wblmhw006"; break;
                   }
            ...
            else if (GetRange(5, nHD))   // * 8000 - 25000
            {
                  ...
                  switch (nRandom)
                  {
                       ...
                       case 4: sItem = "nw_wblmhw006"; break;
