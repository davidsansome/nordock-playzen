...
// ben2_dibbler_od
//
// Dibbler OnDeath script for NPCs. Shouts to allies that they have been killed,
...
void main()
{
object oArea = GetObjectByTag("BenzorDibblersPwnShop");
DelayCommand(600.0, SetLocalInt(oArea,"DeadDibbler",1));
