...
//
// Known bugs/issues...
// - Module name is hardcoded for the function that reloads the module
//
//------------------------------------------------------------------------------
//
// Changelog...
// Version: 002 (22-12-2003)
// - Hardcoded the module name as a workaround to the GetModuleName function
//   problems introduced in 1.61
//
...
void dmwand_ReloadModule()
{
   ...
   // Altered by Michael Tuffin [Grug] 22-12-2003
   // Hardcoded module name to get around bug introduced in 1.61
   StartNewModule("Nordock");
