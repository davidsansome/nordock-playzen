/****************************************************
  Skinnable Animal(Carnivore) - On User Defined Event
  ats_sah_onuser
  ...
  ***Ambrosia Tradeskill System***
  ...
  This script is placed on a skinnable carnivore
...
void main()
{
    ...
    {
       ATS_CreateSkinnableCorpse(oDeadAnimal, CINT_SAC_CORPSE_FADE);
    }
